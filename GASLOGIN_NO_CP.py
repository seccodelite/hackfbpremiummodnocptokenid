...
\033[1;34m[*] \033[1;34m \033[1;31mATHOR\033[1;31m      \033[0;34m:\033[0;34m \033[1;0mMR./EBECK_KANSAS_REAL\033[1;0m
\033[1;34m[*] \033[1;34m \033[1;31mGITHUB\033[1;31m     \033[0;34m:\033[0;34m \033[1;0mhttps://github.com/seccodelite\033[1;0m
\033[1;34m[*] \033[1;34m \033[1;31mSUPPORT BY\033[1;31m \033[0;34m:\033[0;34m \033[1;0mINDONESIAN SEC CODE LITE\033[1;0m

#BTW JANGAN MENYALAH GUNAKAN SC INI YAH SOB, JIKA ADA KERUSAKAN SAYA TIDAK BERTANGGUNG JAWAB!
...
def masuk():
	os.system('clear')
	print logo
	print "》1.) Login Menggunakan Token Facebook"
        print "》2.) EXIT"
        pilih_masuk()

def pilih_masuk():
	msuk = raw_input(" \033[1;31m$ROot> \033[1;31m")
	if msuk =="":
...
def tokenz():
	...
	try:
		...
		os.system('xdg-open https://youtube.com/channel/UCJxbMJ75KHZgTDFfP2TpFHg')
		bot_komen()
	except KeyError:
...
######PILIH######
def pilih():
	unikers = raw_input("SEC CODE NET ")
	if unikers =="":
...
def pilih_indo():
	...
	print "JANGAN DISALAH GUNAKAN YAH SOB SC INI"
        print "BY SEC DONE NET"
